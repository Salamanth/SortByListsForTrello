...
var createStep = function () {
	$('#steps-list').append('<li><span class="drag-handle" title="Move list"><i class="drag-line"></i><i class="drag-line"></i><i class="drag-line"></i></span><input type="text" title="Edit list" class="step-regex" placeholder="List name" value="Step"><i class="delete-step" title="Delete list">&times;</i></li>');
...
var initSteps = function () {
	$.each(_storageSteps, function (index, value) {
		$('#steps-list').append('<li><span class="drag-handle" title="Move list"><i class="drag-line"></i><i class="drag-line"></i><i class="drag-line"></i></span><input type="text" title="Edit list" class="step-regex" placeholder="List name" value="' + value + '"><i class="delete-step" title="Delete list">&times;</i></li>');
	});
}
